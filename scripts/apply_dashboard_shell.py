...
.wf-content .mast{background:#111827;color:#fff;border-radius:16px;padding:22px;position:relative;overflow:hidden}.wf-content .mast .meta{color:#d0d5dd}.wf-content .eyebrow{letter-spacing:.12em;text-transform:uppercase;color:#b6c7ff;font-size:12px;font-weight:900}.wf-content .toolbar{display:flex;gap:10px;flex-wrap:wrap;margin-top:14px}.wf-content .two{display:grid;grid-template-columns:minmax(0,1.05fr) minmax(0,.95fr);gap:12px}.wf-content .actions{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:12px}.wf-content .action,.wf-content .check{border:1px solid #edf0f6;border-radius:14px;background:#fff;padding:13px}.wf-content .action strong{display:block;font-size:16px;margin:6px 0}.wf-content .checklist{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:10px}.wf-content .bars{display:grid;gap:10px;margin:12px 0}.wf-content .bars .bar{display:grid;grid-template-columns:150px minmax(0,1fr) 90px;gap:10px;align-items:center}.wf-content .bars .bar i{display:block;height:12px;border-radius:999px;background:linear-gradient(90deg,#4880ff,#8ab4ff)}.wf-content .danger{border-left-color:#ef3826!important;background:#fff0ee!important}.wf-content .footer{color:#667085;font-size:12px;margin:18px 0 6px}.wf-content .report{max-width:none;margin:0;padding:0}
...
/* DashStack visual adaptation: bright admin shell, blue primary actions, soft metric cards. */
:root{--bg:#f5f6fa;--surface:#fff;--surface-2:#f8f9fc;--ink:#202224;--muted:#6b7280;--line:#e6e9f1;--blue:#4880ff;--green:#00b69b;--amber:#f59e0b;--red:#ef3826;--shadow:0 10px 28px rgba(15,23,42,.06);--focus:#4880ff}
body.wf-app-body{background:#f5f6fa;color:#202224;font-family:"Nunito Sans","PingFang SC","Microsoft YaHei",Arial,sans-serif;font-size:14px}
.wf-page{padding:0}.wf-app{max-width:none;min-height:100vh;width:100%;grid-template-columns:240px minmax(0,1fr);border:0;border-radius:0;background:#f5f6fa;box-shadow:none}
.wf-side{top:0;height:100vh;padding:18px 16px;background:#fff;border-right:1px solid #edf0f6;box-shadow:6px 0 20px rgba(15,23,42,.025)}
.wf-brand{height:52px;padding:0 4px 14px;border-bottom:1px solid #f0f2f6;color:#202224;font-size:17px}.wf-brand small{color:#8b95a5;font-size:11px;letter-spacing:.02em}.wf-mark{width:38px;height:38px;border-radius:12px;background:#eef4ff;color:#4880ff;font-weight:950}
.wf-nav-group[open]{background:transparent;border-color:transparent}.wf-nav-group summary{padding:9px 10px;color:#9aa3b2;font-size:11px;letter-spacing:.04em;text-transform:uppercase}.wf-nav-group nav{gap:5px;padding:2px 0 9px}.wf-side a{min-height:38px;padding:9px 10px;border:0;border-radius:10px;color:#626b7a;font-weight:800}.wf-side a:hover{background:#f4f7ff;color:#4880ff}.wf-side a.active{background:#4880ff;color:#fff;box-shadow:0 8px 18px rgba(72,128,255,.22)}.wf-side .wf-dot{width:7px;height:7px;opacity:.65}.wf-side-foot{border:0;background:#f4f7ff;color:#3567d6;border-radius:14px}
.wf-main{padding:20px 28px 28px}.wf-topbar{top:0;margin:-20px -28px 22px;padding:15px 28px;background:#fff;border-bottom:1px solid #edf0f6;box-shadow:0 8px 24px rgba(15,23,42,.035)}.wf-top-actions{display:flex;align-items:center;gap:10px;flex-wrap:wrap}.wf-global-search{max-width:410px}.wf-global-search input,.wf-topbar-note{height:40px;border-color:#eef1f6;border-radius:12px;background:#f8f9fc;color:#202224}.wf-global-search input:focus{border-color:#4880ff;box-shadow:0 0 0 4px rgba(72,128,255,.12)}.wf-search-results{top:48px;border-color:#edf0f6;border-radius:14px;box-shadow:0 18px 34px rgba(15,23,42,.12)}
.wf-chip{height:36px;display:inline-flex;align-items:center;border-color:#edf0f6;border-radius:10px;background:#fff;color:#596579;font-size:13px}.wf-chip.live{background:#e9fff8;border-color:#c8f6ea;color:#00a88e}
.wf-title-card{min-height:78px;padding:18px 20px;border:0;border-radius:16px;background:#fff;box-shadow:var(--shadow)}.wf-eyebrow{color:#8b95a5;font-size:11px;letter-spacing:.08em}.wf-title-card h1{font-size:24px;color:#202224;font-weight:950}.wf-actions{gap:8px}.wf-btn{border-radius:10px;padding:10px 14px}.wf-btn.primary{background:#4880ff;color:#fff;box-shadow:0 8px 18px rgba(72,128,255,.2)}.wf-btn.green{background:#e9fff8;color:#00a88e}.wf-btn.light{background:#f4f7ff;color:#3567d6}
.wf-kpis{gap:16px}.wf-kpi{border:0;border-radius:16px;background:#fff;padding:18px;box-shadow:var(--shadow)}.wf-kpi .value{font-size:28px;color:#202224}.wf-kpi .label{color:#8b95a5}
.wf-data-alert{border:0;border-left:5px solid #f59e0b;border-radius:16px;background:#fff;box-shadow:var(--shadow)}.wf-data-alert .stamp{color:#f59e0b}
.wf-reader-tools,.profile-toolbar{top:72px;border:0;border-radius:14px;background:#fff;box-shadow:var(--shadow)}.wf-reader-tools input,.profile-toolbar input{height:38px;border-color:#edf0f6;border-radius:10px;background:#f8f9fc}.wf-reader-tools button{height:38px;border-color:#edf0f6;border-radius:10px}.wf-reader-tools button:hover{border-color:#4880ff;background:#f4f7ff;color:#4880ff}
.wf-readable-section{border:0!important;border-radius:16px!important;background:#fff!important;box-shadow:var(--shadow)!important}.wf-readable-section+ .wf-readable-section{margin-top:16px!important}.wf-readable-section>summary{min-height:54px;padding:14px 18px;border-bottom:1px solid #f0f2f6;background:#fff;font-size:17px}.wf-readable-section>summary:before{width:4px;height:22px;background:#4880ff}.wf-section-count{background:#f4f7ff;border-color:#e1e9ff;color:#4880ff}
...
def context(title: str) -> tuple[str, str]:
    rules = [
        ...
        ("周复盘", ("Weekly review", "订单和 WSP 广告驱动的每周止损、验证和预算重排。")),
        ("动作账本", ("Action ledger", "跟踪复盘动作、复查指标、推广规则和止损规则。")),
        ("月复盘", ("Monthly review", "账号、类目、SKU 三层结构诊断和下月动作模板。")),
