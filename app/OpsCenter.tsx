...
function Ads({ tab }: { tab: AdsTab }) {
  ...
  const initialAnalysis=readClientCache<AdAnalysis>(`ads:v3:${initial.start}:${initial.end}`,CLIENT_CACHE_RETENTION_MS);
