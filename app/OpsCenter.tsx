...
function Plan({ embedded = false, onOpenReview, tab, onTabChange }: { embedded?: boolean; onOpenReview: () => void; tab: PlanSection; onTabChange: (tab: PlanSection) => void }) {
  ...
  return <>{!embedded&&<Hero eyebrow="MONTHLY OPERATING PLAN" title="目标与执行" text="6月复盘 → 7月真实基线执行 → 8月下一阶段准备；目标、利润与广告共用同一套运营计划" side={<button className="hero-button" onClick={onOpenReview}>查看完整复盘证据</button>} />}
    ...
    <div className="plan-workspace august-order-workspace">
      ...
      <section className="card promotion-review promotion-rebuilding"><div className="section-head"><div><span>SALES PLAN APPROVED · PROMOTION REBUILD</span><h2>逐Part促销重算</h2></div><b className="promotion-lock">促销审核通过前不可提报紫鸟</b></div><div className="promotion-review-summary"><article><span>销售计划</span><strong>已确认</strong><small>150单拆解已锁定</small></article><article><span>当前步骤</span><strong>促销方案重算</strong><small>核对实时售价与成本</small></article><article><span>利润口径</span><strong>组合利润池</strong><small>逐Part核算，不一刀切</small></article><article><span>紫鸟可提报</span><strong>0</strong><small>等待促销方案审核</small></article></div><footer className="promotion-review-note"><b>销售计划已确认，促销方案进入重算。</b> 将按实时成交价、成本、活动折扣和店铺10%利润硬底线逐Part重建；基础预算与赢家机动池分开，广告与紫鸟仍保持锁定。</footer></section></>}
  </>;
}
