...
function Ads({ tab }: { tab: AdsTab }) {
  ...
  const initialAnalysis=readClientCache<AdAnalysis>(`ads:v4:${initial.start}:${initial.end}`,CLIENT_CACHE_RETENTION_MS);
