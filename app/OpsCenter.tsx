...
function Ads({ tab }: { tab: AdsTab }) {
  ...
  const [liveEnabled,setLiveEnabled]=useState(false); const [batchBusy,setBatchBusy]=useState(false); const [batchMessage,setBatchMessage]=useState('');
