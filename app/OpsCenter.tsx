...
function Ads({ tab }: { tab: AdsTab }) {
  ...
  const approvableQueue=filteredQueue.filter(action=>action.action_type==='SET_LISTING_BID'&&isBulkApprovable(action));
