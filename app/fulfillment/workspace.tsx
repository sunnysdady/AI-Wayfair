  ...
  return (
    <section className={styles.workspace} aria-labelledby="fulfillment-title">
      ...
      <div className={styles.filters} aria-label="订单筛选">
        ...
        <label><span>订单状态</span><select value={status} onChange={(event) => setStatus(event.target.value)}><option value="">全部状态</option><option value="待获取面单">待获取面单</option><option value="SKU待映射">SKU待映射</option><option value="已归档面单">已归档面单</option><option value="待出库">待出库</option><option value="已出库">已出库</option><option value="已发货">已发货</option><option value="异常">异常</option></select></label>
      </div>
      ...
      {selected && <aside className={styles.drawer} aria-label={`编辑 ${selected.orderNumber}`}>
        ...
        <div className={styles.formGrid}>
          ...
          <label><span>发货状态</span><select value={selected.shippingStatus} onChange={(event) => updateSelected("shippingStatus", event.target.value)}>
            <option value="待获取面单">待获取面单</option><option value="SKU待映射">SKU待映射</option><option value="已归档面单">已归档面单</option><option value="待出库">待出库</option><option value="已出库">已出库</option><option value="已发货">已发货</option><option value="异常">异常</option>
          </select></label>
