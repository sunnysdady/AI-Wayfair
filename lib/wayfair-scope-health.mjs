...
export const WAYFAIR_SCOPE_REGISTRY = Object.freeze([
  ...
  {
    id: "product-management-export",
    family: "middle-office-product-management",
    app: "中台导出",
    permission: "Product Management Performance（只读快照）",
    policy: "active",
    evidenceKey: "product-management:v1:last-run",
