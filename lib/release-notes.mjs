...
export const RELEASE_NOTES = Object.freeze({
  ...
  managementBrief: {
    ...
    tomorrow: [
      "拉取新鲜广告 API 数据并与持久快照对账，输出可执行与仅复核两类 Campaign 清单。",
      "为可执行广告动作生成 dry-run、风险校验和回滚方案，等待独立确认后再写入 Bid。",
      "推进 15 项非终态任务的证据、验收和复盘闭环。",
      "复核库存完整基线、Catalog Gate、Scheduler 与财务邮件规则在下一轮真实同步中的表现。",
    ],
  },
  systemUpgrades: [
    {
