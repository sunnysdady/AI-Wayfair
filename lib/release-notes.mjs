...
export const RELEASE_NOTES = Object.freeze({
  ...
  generatedAt: "2026-07-29T08:50:21+08:00",
  productionBaseline: "c80d48e",
  title: "系统功能与逻辑升级日报 · 2026-07-28",
  conclusion: "昨日完成 6 个系统模块和 6 组核心判断逻辑升级：数据读取更完整、执行结论更保守、广告与促销共享同一授权计划，所有高风险动作都必须经过证据、验收和回滚约束。",
  git: {
    branch: "deploy",
    commits: 66,
  ...
  systemUpgrades: [
    {
      ...
      detail: "订单邮件提取订单号、SKU、商品、数量和金额；回款邮件提取 Remittance、发票和付款字段；服务器每两小时生成 Outlook 日报快照。",
      outcome: "运营人员可直接查看可执行事实，不再从邮件摘要里人工拼接订单和回款信息。",
    },
    {
      area: "02 · 商品经营与上新",
    ...
    },
    {
      ...
      detail: "建立完整 Part × Warehouse TRUE_UP 基线，补齐缺失零库存行，并将批次提交、处理中、终态回执和生效回读拆开记录。",
    ...
    },
    {
      ...
      detail: "新增操作状态机、事件账本、执行证据、验收人、复盘结论和回滚链接；同步加固安全响应头、时间戳归一化与瞬态读取重试。",
      outcome: "任务不能仅凭按钮点击关闭；每个完成结论都必须能追溯执行结果和验收证据。",
    },
  ],
  logicUpgrades: [
    {
  ...
  outlook: {
    syncedAt: "2026-07-28T18:58:18+08:00",
    total: 14,
    unread: 6,
    actionRequired: 14,
    highestPriority: "P1",
  ...
  followUps: [
    "继续观察广告 Modify Bids 作用域的新鲜度；在没有单独实盘授权时保持广告写入 Gate 关闭。",
    "为待验收、待复盘和失败任务补齐证据，但不把业务任务数量作为系统升级日报的主指标。",
