...
const rows = [
  ...
  },
  {
    ...
    tactic: "最高毛利修复款；先修Catalog与承接，再用小流量验证，不直接全量恢复。",
    gate: "Catalog全部LIVE、主图与价格复核通过，且首10击至少1单后才解锁机动预算。",
    stopRule: "任一Part成本缺失不得投放；重测累计12击0单则整组暂停并保留自然单。",
  },
  {
    listing: "DMOM1018",
    parts: ["LFC-2B", "LFC-2W"],
  ...
  },
  {
    ...
    tactic: "零销售恢复观察；只承接自然订单，不分配广告预算。",
    gate: "补齐当前SKU成本并确认链接LIVE后，才进入下一轮广告或促销评估。",
    stopRule: "成本未补齐、链接未通过或无自然转化时持续$0预算，不承担冲量责任。",
  },
];
