...
function assistantHelpReply() {
  return {
    ...
    message: [
      ...
      "• SKU 成本：成本金额与币种。",
      "• 库存：最新快照中的现货、在途和仓库。",
      "• 订单：SKU 对应的采购订单、数量、日期；支持日销售与 SKU 月度汇总。",
      "• 广告动作：已记录的广告动作、状态和 Campaign ID（不等同于实时广告表现）。",
      "• 运营任务：任务标题、状态、负责人和关联对象。",
      "• 报告：已上传报告的标题、类型和文件名。",
      "• 日报：已存档的 Outlook 日报内容与日期。",
      "\n使用场景",
      "• 补货判断：输入“DMOM1021 库存风险”。",
      "• 销售复盘：输入“8.23 的销量是多少”或“查询 DMOM1027 8 月的订单数据”。",
      "• 运营跟进：输入 SKU、订单号、报告标题或任务关键词，查看关联记录。",
      "• 广告协同：输入 Listing 或 Campaign ID，查询已保存的广告动作；实时投放数据需以同步结果为准。",
