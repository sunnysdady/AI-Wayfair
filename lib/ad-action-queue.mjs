...
export function canRemoveAction(status) {
  return ["PLANNED", "FAILED"].includes(status);
}
...
function resultTime(value) {
  ...
  return new Intl.DateTimeFormat("zh-CN", {
    timeZone: LINGXING_TIME_ZONE, year: "numeric", month: "2-digit", day: "2-digit", hour: "2-digit", minute: "2-digit", hourCycle: "h23",
