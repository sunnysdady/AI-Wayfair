...
export function diagnoseAiCampaign(input) {
  ...
  const active = isActiveCampaign(input);
  ...
  if (daysActive > AI_LEARNING_DAYS) {
    return {
      ...
      noDailyCap,
      significantChangesBlocked: true,
      summary: `已运行${daysActive}天且最近14天仅${orders14d}/50个归因订单，学习期超过14天。`,
      guardrail: "联系 Account Manager；确认前不要修改 tROAS、Daily Cap 或 Listing，紧急止损仅允许人工暂停整个 Campaign。",
    };
  }
