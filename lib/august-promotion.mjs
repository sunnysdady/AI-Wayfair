...
export const AUGUST_PROMOTION_EVENTS = Object.freeze([
  ...
  submittedEvent({
    ...
    canRelyOnForPlan: true,
    planningNote: "7个B2C SKU按8%提交，B2B未提报；等待Wayfair处理/排期。",
  }),
  submittedEvent({
  ...
  submittedEvent({
    ...
    planningStatus: "SUBMITTED_PROCESSING",
    canRelyOnForPlan: true,
    planningNote: "15个SKU已提交；主活动窗口，按实际生效SKU承接销量。",
  }),
  submittedEvent({
    ...
    planningStatus: "SUBMITTED_PROCESSING",
    canRelyOnForPlan: true,
    planningNote: "15个SKU已提交；冲量窗口仍按店铺利润率与库存Gate放量。",
  }),
  submittedEvent({
    ...
    planningStatus: "SUBMITTED_PROCESSING",
    canRelyOnForPlan: true,
    planningNote: "15个SKU已提交；月末收口窗口，只给通过利润、库存和转化Gate的SKU放量。",
  }),
]);
...
export const AUGUST_QUANTITY_PROMOTION = Object.freeze({
  ...
  projectId: "16685396",
  name: "B2B Buy 2 Save 5% - August 2026",
  status: "PROCESSING",
  submittedAt: SOURCE_AS_OF,
  minimumQuantity: 2,
...
function part(input) {
  ...
  return Object.freeze({
    ...
    activeEventIds: isSubmitted ? Object.freeze(["q3-priority-product-discounts-2026"]) : Object.freeze([]),
    submittedEventIds: isSubmitted
      ...
      : Object.freeze([]),
    memberB2cDiscount:
      isSubmitted && input.eventGroup === "FILING_CORE" ? 0.08 : null,
...
export const AUGUST_PROMOTION_PLAN = Object.freeze([
  ...
  part({
    ...
    b2cDiscount: 0.1,
    b2bTotalDiscount: 0.15,
    approvedMarginFloor: 0.18,
    reason: "高评分、高库存的B2B/自然次级跑量款；已批准促销毛利压缩至18%底线，叠加多件优惠的订单不追加广告。",
  }),
  part({
    listing: "DMOM1019",
    part: "VFC-3W",
