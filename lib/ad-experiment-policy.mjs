...
const BASE_AD_PLAN = AUGUST_EXECUTION_POLICY.baseAdBudget;
const CONSERVATIVE_MARGIN_RATE = 0.340504;
const PORTFOLIO_MAX_LOSS = AUGUST_EXECUTION_POLICY.canaryLossCap;
...
export const AD_CANARY_RISK_POLICY = Object.freeze({
  ...
  earliestStart: AUGUST_EXECUTION_POLICY.earliestCanaryStart,
