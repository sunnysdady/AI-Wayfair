// All business-day surfaces use a fixed UTC-4 boundary throughout the year.
// IANA's Etc/GMT sign is inverted: Etc/GMT+4 means UTC-4.
export const LINGXING_TIME_ZONE = "Etc/GMT+4";
